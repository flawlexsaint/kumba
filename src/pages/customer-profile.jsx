...
import ProfileImage from "../assets/images/profile-pix.svg";

const CustomerProfile = ({ orderInformation }) => {
              ...
              <div className="row">
                <div className="col-md-5">
                  <div className="text-center">
                    <img src={ProfileImage} className="profile-pix" alt="" />
                  </div>
                  <div className="row mt-4">
                    ...
                    <div className="col-6 d-flex justify-content-center">
                      <div className="d-flex ">
                        ...
                        <ul className="ms-2">
                          {orderInfo.user.dislikes.map((dislike) => (
                ...
                <div className="col-md-7 sm">
                  <div className="container">
                    <div className="d-flex justify-content-between">
                      <div className="profile_card_text">
                        <span>Name:</span>
                        <p className="">{orderInfo.user.name}</p>
                      </div>
                      <Link to={`order-summary/${orderInfo.order_id}`}>
                        <img src={Cart} className="cart" alt="cart" />
                      </Link>
                    </div>
                    <div className="profile_card_text">
                      <span>Tel:</span>
                      <p className="">{orderInfo.user.phone}</p>
                    </div>
                    <div className="profile_card_text">
                      <span>Address:</span>
                      <p className="">{orderInfo.user.address}</p>
                    </div>
                    <div className="profile_card_text">
                      <span>About:</span>
                      <p className="">{orderInfo.user.about}</p>
                    </div>
                  </div>
                </div>
              </div>
